...
def checklist():
	...
	url = "https://api.tropo.com/1.0/sessions?action=create&token=4c5a5241586e6465596d4a75524f597545564843687749716c7568484d4c454d725154764e52586f45627a69&cust_number=" + phone + "&name=" + '+'.join(name.split(' '))
